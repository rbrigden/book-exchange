...
# unless rb || av
#   av = User.new(first:'Abhinav', last:'Venigalla', email: 'aveni@mit.edu', password: 'abhiveni', password_confirmation: 'abhiveni')
#   rb = User.new(first:'Ryan', last:'Brigden', email: 'rbrigden@cmu.edu', password: 'ryanbrig', password_confirmation: 'ryanbrig')
